            ...
            <View style={{padding: 10}}>
                <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                    <View style={{flexDirection: "row", alignItems: "center", marginTop: 5}}>
                        <TouchableOpacity style={{backgroundColor: 'black', borderRadius: 15}}>
                            <Entypo style={{borderWidth: 1, borderColor: "black", borderRadius: 15, padding: 2}} name="moon" size={24} color="white" />
                ...
                <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 20}}>
                    ...
                    <View style={{flexDirection: "row", alignItems: "center", marginTop: 15}}>
                        <TouchableOpacity style={{backgroundColor: '#ff292c', borderRadius: 17, paddingTop:1, paddingBottom:1, paddingLeft: 5, paddingRight: 5}}>
                        ...
                        <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                    <View style={{flexDirection: "row", alignItems: "center", marginTop: 5}}>
                        <TouchableOpacity style={{backgroundColor: 'cyan', borderRadius: 18, padding: 5, paddingBottom: 7, paddingLeft: 6, paddingRight: 6}}>
