      ...
      <View>
        ...
        <ScrollView>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-around"}}>
            ...
            >
              <AntDesign style={{paddingLeft: 5, marginRight: 5}} name="videocamera" size={18}
                         color="black"/>
            ...
            >
              <FontAwesome style={{paddingLeft: 5, marginRight: 5}} name="spoon" size={18}
                           color="black"/>
            ...
            >
              <MaterialCommunityIcons style={{paddingLeft: 5, marginRight: 5}}
                                      name="gamepad-variant-outline" size={24} color="black"/>
          ...
          <View style={styles.video}>
            ...
            <View>
              ...
              >
                <Foundation style={{paddingLeft: 8}} name={this.state.iconVideo} size={26}
                            color="white"/>
            ...
            <View style={{
              ...
              <TouchableOpacity style={{flexDirection: "row", alignItems: "center"}}>
                ...
                <Text style={{marginLeft: 5, marginTop: 5, fontSize: 11, color: "gray"}}>1.005
                  thích</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{flexDirection: "row", alignItems: "center"}}>
                <Text style={{marginLeft: 5, marginTop: 5, fontSize: 11, color: "gray"}}>315 bình
                  luận</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{flexDirection: "row", alignItems: "center"}}>
                <Text style={{marginLeft: 5, marginTop: 5, fontSize: 11, color: "gray"}}>138 chia
                  sẻ</Text>
              </TouchableOpacity>
            </View>
            <Text style={{backgroundColor: "#d6d7db", width: "100%", height: 1}}></Text>
              ...
              <View style={styles.modalView}>
                ...
                <View style={{flexDirection: "row", padding: 10, alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{marginLeft: 20, fontSize: 12, color: "gray"}}>Thêm vào danh sách
                      video đã lưu</Text>
                ...
                <View style={{flexDirection: "row", padding: 10, alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{marginLeft: 20, fontSize: 12, color: "gray"}}>Ẩn bớt các bài viết
                      tương tự</Text>
                ...
                <View style={{flexDirection: "row", padding: 10, alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{marginLeft: 20, fontSize: 12, color: "gray"}}>Không xem bài viết
                      của Trang này nữa</Text>
                ...
                <View style={{flexDirection: "row", padding: 10, alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{marginLeft: 20, fontSize: 12, color: "gray"}}>Tôi lo ngại về bài
                      viết này </Text>
                ...
                <View style={{flexDirection: "row", padding: 10, alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{marginLeft: 20, fontSize: 12, color: "gray"}}>Xem video và bài
                      viết từ VTV Giải trí</Text>
