    ...
    return (
      <Container>
        ...
        <Item onPress={this._onPressButton1} style={{paddingBottom:10}} >
          ...
          <Text style={{color:'blue',fontWeight:'bold'}} > Đăng nhập bằng tài khoản khác</Text>
        </Item>
        <Item onPress={this._onPressButton2} style={{paddingBottom:10}}>
          <Icon style={{color:'blue',fontWeight:'bold'}} type="FontAwesome" name="search"/>
          <Text style={{color:'blue',fontWeight:'bold'}} >Tìm tài khoản</Text>
        </Item>
